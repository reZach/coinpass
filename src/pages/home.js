                ...
                <div className="row mb-4">
                    ...
                    <div className="col-sm-8 col-12">
                        ...
                        <ol style={{ listStyleType: "decimal" }}>
                            <li style={{ textAlign: "left" }}>Write down the code (which begins with two letters), and number (underneath the code), on your coin on a piece of spare paper.</li>
                            ...
                            <li style={{ textAlign: "left" }}>Using the code you wrote down in step 1, log <em>where</em> you did this act of service on <a href="/#action">this page</a>. You can view how far your coin has traveled on <a href="/#map">this page</a> using the number found on your coin.</li>
                        </ol>
